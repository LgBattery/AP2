...
public class VheicleDestruction : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        // If the object is a wheel dont detect collision
        if (!ArrayContains(wheels, parts[partIndex].part))
        {
    ...
    public void DoDamage(Transform part_, int damage)
    {
            ...
            (parts[partIndex].healthBar == false))
        {
            ...
            hb.GetChild(0).GetComponent<HealthBar>().part = parts[partIndex];
        ...
        {
            healthCounter = healthCounter + parts[i].health;
        }
