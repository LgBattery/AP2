...
public class PlayerMovementr : MonoBehaviour
{
    ...
    private void Look()
    {
        ...
        Vector3 rot = playerCam.GetChild(0).transform.localRotation.eulerAngles;
        ...
        playerCam.transform.GetChild(0).localRotation = Quaternion.Euler(xRotation, desiredX, 0);
